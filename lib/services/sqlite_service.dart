...
class SqliteService {
  Future initializeDB() async {
    ...
    return openDatabase(join(path, 'database.db'),
      ...
      await database.execute(
          'CREATE TABLE Transactions(id INTEGER PRIMARY KEY AUTOINCREMENT, amount INTEGER NOT NULL, categoryId INTEGER NOT NULL, resourceId INTEGER NOT NULL, createdAt TEXT, description TEXT, FOREIGN KEY (categoryId) REFERENCES Categories(id), FOREIGN KEY (resourceId) REFERENCES Resources(id))');
    }, version: 1);
  }
}
